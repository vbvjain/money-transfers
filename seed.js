...
async function seed() {
    try {
        ...
        console.log(`Created account ${user1BasicSaving.accountId} of type ${user1BasicSaving.type} for user1 with Rs. 30000`)
        ...
        console.log(`Created account ${user2BasicSaving.accountId} of type ${user2BasicSaving.type} for user2 with Rs. 30000`)
        ...
        console.log(`Created account ${user2Saving.accountId} of type ${user2Saving.type} for user2 with Rs. 30000`)
        ...
        console.log(`Created account ${user3BasicSaving.accountId} of type ${user3BasicSaving.type} for user3 with Rs. 30000`)
        ...
        console.log(`Created account ${user3Saving.accountId} of type ${user3Saving.type} for user3 with Rs. 30000`)
        ...
        console.log(`Created account ${user3Current.accountId} of type ${user3Current.type} for user3 with Rs. 30000`)
        ...
        console.log(`Created account ${user4Current.accountId} of type ${user4Current.type} for user4 with Rs. 30000`)
        ...
        console.log(`Created account ${user4Saving.accountId} of type ${user4Saving.type} for user4 with Rs. 30000`)
        ...
        console.log(`Created account ${user5Current.accountId} of type ${user5Current.type} for user5 with Rs. 30000`)
        ...
        console.log(`Created account ${user5Current2.accountId} of type ${user5Current2.type} for user5 with Rs. 30000`)
    } catch (e) {
        console.log(e)
    }
